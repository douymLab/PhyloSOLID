...
if features_file is None or features_file == "None":
    ...
    df_for_classifier['mutation_id'] = (
        df_for_classifier['chrom'].astype(str) + "_" + 
        df_for_classifier['end'].astype(str) + "_" + 
        df_for_classifier['ref_allele'].astype(str) + "_" + 
        df_for_classifier['alt_allele'].astype(str)
    )
    
    results_of_classifier = real_time_classifier_predict(df_for_classifier, sampleid, outputpath_classifier)
    
    df_results_of_classifier = results_of_classifier[0]
...
if is_predict_germ=="yes":
    ...
    stats_df, germline_mutations = identify_germline_variants(
        P=P_candidate, V=V_candidate, C=C_candidate, df_reads=df_reads_candidate, df_features_new=df_features_new, 
...
# heatmap 中展示鉴定结果
plot_heatmap_with_germline_mutations(I_candidate, predicted_germline_mutations, os.path.join(outputpath_germline, sampleid+".heatmap_with_predicted_germline_mutations_and_histograms.pdf"))
...
somatic_mutations = [i for i in candidate_mutations if i not in removed_germline_mutations and i not in removed_artifact_mutations]
P_somatic = P_candidate[somatic_mutations].copy()
V_somatic = V_candidate[somatic_mutations].copy()
A_somatic = A_candidate[somatic_mutations].copy()
C_somatic = C_candidate[somatic_mutations].copy()
I_somatic = I_candidate[somatic_mutations].copy()
df_reads_somatic = df_reads_candidate[somatic_mutations].copy()
...
if is_detect_passtree_by_dp=="yes":
    ...
    uppasstree_mutations = [i for i in candidate_mutations if i not in passtree_mutations]
else:
    logging.info("Skip running dynamic programming ...")
    passtree_mutations = candidate_mutations
...
# -----------------------------
# Step 6.2: 处理 external_mutations_of_attached_on_scaffold, 也就是第一次在树上找不到 intersection 的 mut 再挂一次
# -----------------------------
...
#                 └─ 3_139797361_G_A
#                 └─ 12_58058137_C_T
#                   └─ 19_38404452_C_T|1_106340339_G_T
#     └─ 1_212476040_A_G
#       └─ 5_72979186_C_T
#   └─ 9_4449186_G_A
#     └─ 7_116040833_G_A
...
#       └─ 2_26914023_G_A
#         └─ 8_50806767_T_A
#           └─ 2_22478421_A_G|18_69229857_A_G
#             └─ 7_68820962_G_A|11_14868899_A_T
#               └─ 4_171339863_A_G
#                 └─ 8_127028930_G_A
#                   └─ 12_52644508_C_T
#                     └─ X_135442114_T_G|4_154649455_C_T
#   └─ 4_171901716_C_T
#     └─ 2_113547098_C_G
#       └─ 5_154234034_G_A
#         └─ 11_130790503_G_A
#           └─ X_70632344_G_A
#             └─ 8_23437628_G_A
#         └─ 5_152500272_C_A|9_103459386_G_A
#           └─ 20_13387559_C_T|6_9290383_C_T
#       └─ 6_135159748_C_T
#   └─ 4_170816788_G_A
#     └─ 16_62830915_C_T
#       └─ 7_3867983_A_C
...
# 0     10_4300581_C_T  ...                                     0.0
# 1   11_119390339_C_T  ...                                     0.0
# 2   11_130790503_G_A  ...                                     0.0
# 3    11_14868899_A_T  ...                                     0.0
# 4    11_28736674_C_A  ...                                     0.0
# ..               ...  ...                                     ...
# 71     9_4449186_G_A  ...                                     0.0
# 72    9_76779133_T_G  ...                                     0.0
# 73   X_135442114_T_G  ...                                     0.0
# 74   X_138790531_G_A  ...                                     0.0
# 75    X_70632344_G_A  ...                                     0.0
...
# 0   8_135332005_A_C       0.0  0.000000
# 1     5_3926977_C_G       0.0  0.000000
# 2    3_20458612_C_T       0.0  0.000000
# 3   5_156493734_T_C       0.0  0.166667
# 4    3_18578000_G_T       0.0  0.333333
# ..              ...       ...       ...
# 71  16_83107928_G_A       0.0  0.000000
# 72  11_56099914_C_T       0.0  0.000000
# 73  18_68053436_G_A       0.0  0.000000
# 74    5_4257259_C_A       0.0  0.000000
# 75  6_135159748_C_T       0.0  0.000000
...
# 0   8_135332005_A_C         8_135332005_A_C  ...                       8             22
# 1     5_3926977_C_G         8_135332005_A_C  ...                       7             22
# 2    3_20458612_C_T         8_135332005_A_C  ...                       6             22
# 3   5_156493734_T_C         8_135332005_A_C  ...                       5             22
# 4    3_18578000_G_T         8_135332005_A_C  ...                       4             22
# ..              ...                     ...  ...                     ...            ...
# 71    7_3867983_A_C         4_170816788_G_A  ...                       1              7
# 72  16_83107928_G_A         4_170816788_G_A  ...                       1              7
# 73  11_56099914_C_T         4_170816788_G_A  ...                       1              7
# 74  18_68053436_G_A         4_170816788_G_A  ...                       1              7
# 75    5_4257259_C_A         4_170816788_G_A  ...                       1              7
...
#           identifier subclone_representative.1_x  ...  total_ones_in_subclone.2  subclone_size.2_y
# 0     10_4300581_C_T             8_135332005_A_C  ...                         2                 22
# 1   11_119390339_C_T             8_135332005_A_C  ...                         2                 22
# 2   11_130790503_G_A             4_171901716_C_T  ...                         2                 11
# 3    11_14868899_A_T             7_122592074_G_T  ...                         1                 13
# 4    11_28736674_C_A               9_4449186_G_A  ...                         2                 10
# ..               ...                         ...  ...                       ...                ...
# 71     9_4449186_G_A               9_4449186_G_A  ...                         3                 10
# 72    9_76779133_T_G              9_76779133_T_G  ...                         4                 13
# 73   X_135442114_T_G             7_122592074_G_T  ...                         1                 13
# 74   X_138790531_G_A             8_135332005_A_C  ...                         2                 22
# 75    X_70632344_G_A             4_171901716_C_T  ...                         2                 11
...
# -----------------------------
# Step 6.8 计算 cross all cells 的 fp_ratio_per_mutation 和 cross all mutations 的 fp_ratio_per_cell，鉴定并去掉 artifact mutations 和 doublet cells
# -----------------------------
...
# 0   8_135332005_A_C               0  ...                 14                    22
# 1     5_3926977_C_G               0  ...                 15                    22
# 2    3_20458612_C_T               0  ...                 16                    22
# 3   5_156493734_T_C               0  ...                 17                    22
# 4    3_18578000_G_T               0  ...                 18                    22
# ..              ...             ...  ...                ...                   ...
# 71   8_23437628_G_A               0  ...                 21                    22
# 72   8_35604654_T_C               0  ...                 20                    21
# 73   8_50806767_T_A               0  ...                 21                    22
# 74  9_103459386_G_A               0  ...                 21                    22
# 75  X_135442114_T_G               0  ...                 20                    21

# [76 rows x 6 columns]

df_fp_ratio_per_cell_cross_all_muts
#        cell_id  fp_muts_count  ...  total_zeros_muts  total_coverage_muts
# 0   SRR6349063              0  ...                67                   74
# 1   SRR6349064              0  ...                68                   71
# 2   SRR6349066              0  ...                69                   75
# 3   SRR6349067              0  ...                69                   74
# 4   SRR6349068              0  ...                67                   75
# 5   SRR6349069              0  ...                74                   76
# 6   SRR6349070              0  ...                66                   75
# 7   SRR6349071              0  ...                74                   76
# 8   SRR6349072              0  ...                62                   75
# 9   SRR6349073              0  ...                74                   76
# 10  SRR6349074              0  ...                68                   74
# 11  SRR6349075              0  ...                71                   75
# 12  SRR6349076              0  ...                69                   76
# 13  SRR6349077              0  ...                63                   76
# 14  SRR6349078              0  ...                72                   75
# 15  SRR6349079              0  ...                62                   75
# 16  SRR6349080              0  ...                72                   76
# 17  SRR6349081              0  ...                69                   76
# 18  SRR6349082              0  ...                64                   74
# 19  SRR6349083              0  ...                62                   74
# 20  SRR6349084              0  ...                69                   76
# 21  SRR6349085              0  ...                70                   76
...
# -----------------------------
# Step 6.9 计算 parent muts 中的 intersection/FN_flip per mutations，最后找到一些要重挂的突变
# -----------------------------
...
# -----------------------------
# Step 6.10 计算 parent muts 中的 intersection/FN_flip per mutations，最后找到一些找不到合适的突变的可以删除的 cells
# -----------------------------
...
#             intersection_count  flipping_count_fn  flipping_count_NAto1  flipping_to_1_count
# cell                                                                                        
# SRR6349070                   9                  3                     0                    3
# SRR6349071                   2                  0                     0                    0
# SRR6349072                  13                  1                     0                    1
...
# with open(os.path.join(outputpath_full, "likely_doublet_cells_removed_from_tree.csv"), 'w') as f:
...
# total_flipping_False_Negative    15
# total_flipping_False_Positive     0
# total_flipping_NA_to_0           22
# total_flipping_NA_to_1            0
# Name: 0, dtype: int64
