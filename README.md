...
**Visualization ready**: Use the `phylo/` directory (in `03_tree_building/`) as input to [PhyloSOLIDvis](https://github.com/TsingYang1112/PhyloSOLIDvis) to generate publication-ready circos plots:

<div align="center">
  <img src="https://raw.githubusercontent.com/TsingYang1112/PhyloSOLIDvis/master/inst/demo_circos.png" alt="Example circos plot from PhyloSOLIDvis" width="700">
  <br>
  <em>Figure: Example circos plot generated from PhyloSOLID output (351 cells, 17 mutations)</em>
</div>
